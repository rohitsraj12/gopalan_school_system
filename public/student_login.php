  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <body id="mimin" class="dashboard form-signin-wrapper">
      ...
      <div class="container">
        ...
        <form action="include\student.inc\login.inc.php" method="POST" class="form-signin">
          <div class="panel periodic-login">
              <div class="panel-body text-center">
                  <h1 class="atomic-symbol">GIS</h1>
                  
                  <p class="element-name">Gopalan Foundation</p>
                  <p class="atomic-mass">Student Login</p>

                  <i class="icons icon-arrow-down"></i>
                  <div class="form-group form-animate-text" style="margin-top:40px !important;">
                    <input type="text" name="student_id" class="form-text" id="email" aria-describedby="emailHelp" required>
                  ...
                  <input type="submit" name="login-student" class="btn col-md-12" value="SignIn"/>
              </div>
