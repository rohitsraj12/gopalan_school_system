            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Notice Board</h3>
                        <p class="animated fadeInDown">
                          Notice Board <span class="fa-angle-right fa"></span> All
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Notice Board</h3></div>
                    <div class="panel-body">
                        ...
                        <tbody>
                          <?php 
                            // $query = "SELECT * FROM notice_board";
                              ...
                              $query = "SELECT notice_board.*, schools.*, notice_categories.* FROM notice_board
                              JOIN schools
                                  ON schools.school_id = notice_board.school_id
                              JOIN notice_categories
                                  ON notice_categories.category_id = notice_board.category_id";
