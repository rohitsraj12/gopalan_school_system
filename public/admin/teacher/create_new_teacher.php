    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
          <div class="panel-body">
            <div class="col-md-12">
                <h3 class="animated fadeInLeft">Create Teacher Profile</h3>
                <p class="animated fadeInDown">
                  Teachers <span class="fa-angle-right fa"></span> Create Teacher Profile
                </p>
            </div>
          </div>
        </div>
        <div class="form-element">
          ...
          <div class="col-md-12 panel">
            ...
            <div class="col-md-12 panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
                <form class="cmxform" id="signupForm" method="POST" action="include/create_teacher_account.inc.php">
                  <div class="col-md-6">
                    ...
                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                      <input type="text" class="form-text" id="validate_emp_id" name="emp_id" required>
                      <span class="bar"></span>
                      <label>Emp ID</label>
                    </div>
                    ...
                    <div class="form-group form-animate-text" style="margin-top:0px !important;">
                        ...
                        <select class="form-control" id="validate_position" name="position" required>
                            <option value="no_value">Select Teacher Position</option>
                            <?php
