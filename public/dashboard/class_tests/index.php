<?php
 // add new teacher in teacher record
    ...
    <div id="content">
        ...
        <?php
            include('include/create_exam.inc.php');
        ?>
                        ...
                        <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($exam_rows = mysqli_fetch_assoc($exam_result)){
                                ?>
                                <tr>
                                    <td>22/06/2021</td>
                                    <td>4th std - B</td>
        ...
        <div class="col-md-4">
            <div class="panel box-v1">
                ...
                <div class="panel-body text-center">
                    ...
                    <hr/>
                    <p>
                        <button class="btn btn-danger box-shadow-none"  data-toggle="modal" data-target="#create_exam">ceate new test</button>
                    </p>
                </div>
    ...
    <div class="modal fade" id="create_exam" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-content">
                ...
                <form class="cmxform" id="signupForm" method="POST" action="">
                    <div class="modal-body">
                        <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" id="validate_firstname" name="subject" required>
                                <span class="bar"></span>
                                <label>Subject</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" id="validate_lastname" name="std" required>
                                <span class="bar"></span>
                                <label>Class</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="date" class="form-text" id="validate_username" name="date" required>
                                <span class="bar"></span>
                                <!-- <label>Date</label> -->
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" id="validate_email" name="div" required>
                                <span class="bar"></span>
                                <label>Section</label>
                            </div>
                        </div>                   
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="create_exam" value="Submit">Save changes</button>
                    </div>
